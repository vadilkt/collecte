    ...
    <div className="h-screen overflow-auto flex items-center justify-center">
        <div className="w-[450px] h-[500px] bg-white rounded-lg px-8 pb-8">
          ...
          <div className="mt-8 px-8 space-y-4">
            <Link href="/login">
              <a className="bg-green-600 text-white px-4 rounded-md py-2.5 block w-full text-center" rel="noopener noreferrer">
                Se connecter
              </a>
            </Link>
            <Link href="/register">
              <a className="bg-gray-600 text-white px-4 rounded-md py-2.5 block w-full text-center" rel="noopener noreferrer">
                S'enregistrer
              </a>
            </Link>
            <Link href="/admin-login">
              <a className="bg-red-800 text-white px-4 rounded-md py-2.5 block w-full text-center" rel="noopener noreferrer">
                Administrer
              </a>
            </Link>
          </div>
